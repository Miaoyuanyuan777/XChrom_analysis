...
df <- read_csv('inter_method_auc.csv')
...
ggplot(df, aes(x = Metric, y = Value,)) +
  ...
  scale_fill_manual(values = c("Seurat" = "skyblue", 'LS_Lab' = "pink",'MultiVI'='#CC99E6',"XChrom" = "#FFB07C")) +  # 自定义箱线图颜色
...
ggsave("inter_method_auc_box1.pdf", plot = last_plot(), 
